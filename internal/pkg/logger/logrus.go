...
func (l *logrusLogger) TIKIDebugf(ctx context.Context, format string, args ...interface{}) {
...
func (l *logrusLogger) TIKIInfof(ctx context.Context, format string, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIPrintf(ctx context.Context, format string, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIWarnf(ctx context.Context, format string, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIErrorf(ctx context.Context, format string, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIPanicf(ctx context.Context, format string, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIDebug(ctx context.Context, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIInfo(ctx context.Context, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIPrint(ctx context.Context, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIWarn(ctx context.Context, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIError(ctx context.Context, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIPanic(ctx context.Context, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIDebugln(ctx context.Context, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIInfoln(ctx context.Context, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIPrintln(ctx context.Context, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIWarnln(ctx context.Context, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIErrorln(ctx context.Context, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) TIKIPanicln(ctx context.Context, args ...interface{}) {
	if lg := l.getLoggerFromContext(ctx); lg != nil {
...
func (l *logrusLogger) getLoggerFromContext(ctx context.Context) *logrusLogger {
	...
	lg := ctx.Value(TIKILoggerConText)
	if lg == nil {
		return nil
	}
